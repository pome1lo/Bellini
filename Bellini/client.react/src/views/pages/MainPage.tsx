    ...
    return (
        <>
            <div className="flex flex-col items-center p-7">
                <div className="text-center max-w-[600px] mt-32">
                    <h1 className="text-6xl font-bold">The designer<br/>of marketing quizzes</h1>
                    <p className="mt-3 mb-4 text-xl">Quizzes create a Business-Client dialogue and help visitors and
                ...
                <div className="text-start items-start w-full max-w-[1090px] mt-10 mb-10">
                    <h1 className="text-5xl font-bold">Not only a tool, but also a method</h1>
                    <h3 className="text-2xl">Let's tell you how to make a quiz the most effective tool in marketing</h3>
                </div>
