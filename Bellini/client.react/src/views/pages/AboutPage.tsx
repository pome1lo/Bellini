        ...
        <>
            ...
            <div className="p-4 space-y-6 max-w-xl flex m-auto flex-col items-center">
                ...
                <ol className="list-decimal ml-5 space-y-2">
                    ...
                    <li  >Setup the database by configuring your <code>appsettings.json</code> with the MS SQL Server connection string and running the migrations:<code className="text-green-700 p-2 rounded">dotnet ef database update</code></li>
